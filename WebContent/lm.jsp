...
<div id="showbox">
  <img src="images/lm/lm1.jpg" width="300" height="300" />
  <img src="images/lm/lm2.jpg" width="300" height="300" />
  <img src="images/lm/lm3.jpg" width="430" height="430" />
  <img src="images/lm/lm4.jpg" width="290" height="290" />
  <img src="images/lm/lm5.jpg" width="300" height="300" />
...
<div class="miaoshu">
   <div class="m1">俄罗斯蓝猫（学名：Russian Blue cat）</div> 
   <div class="m2">【更多请联系qq:19902134】</div>
     <div class="m3">
     <span class="m3-1">宠物之家价格：</span>
    <!-- <img src="images/doller.jpg">-->
     <span class="m3-2">￥1500元 </span>
     <div class="m31">市场价：￥3000</div>
     </div>
   ...
   <input type="button" onclick="numAdd()" value="+" id="add">
    ...
    <div class="sdsd">金额总计: <span id="totalPrice">1500</span></div>  
